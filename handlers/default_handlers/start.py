...
def start_handler(message):
    ...
    <b>🎮 КАК ИГРАТЬ (3 шага):</b>
    1️⃣ <b>ВЫБЕРИ ГОРОД</b> → персональная погода
    2️⃣ <b>/interests</b> → твои новости (технологии/спорт...)
    3️⃣ <b>/digest</b> → 5 новостей + <b>заработай пачку!</b>
    ...
    👇 <b>ПЕРВЫЙ ШАГ: Выбери свой город!</b>
    <i>или 'Другой город' для ручного ввода</i>""",
        parse_mode='HTML',
